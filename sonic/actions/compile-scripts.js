 ...
 * This is used to compile source scripts to the destination directory, and to minify them in production.
 *
 * Usage:
...
export default async function compileScripts(sourceGlobs = '', destinationPath = '') {
  ...
  // Compile the scripts. Each entryPoints key becomes the output filename (basename without extension),
  // so e.g. website/assets/scripts/main.js is emitted as <destination>/main.js.
