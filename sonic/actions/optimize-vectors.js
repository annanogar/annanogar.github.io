 ...
 * This is used to optimize source vectors in place, and to ensure that they are optimized before being compiled or copied to the destination directory.
 *
 * Usage:
...
const processSource = async (source = '', hashCache = null) => {
  ...
  try {
    ...
    throw new Error(`SVG Parse Error in "${source}": ${error.reason} (${error.line}:${error.column}).`, { cause: error })
  }
