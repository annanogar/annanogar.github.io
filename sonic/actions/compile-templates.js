 ...
 * This is used to compile source templates to the destination directory.
 *
 * Usage:
...
const processSource = async (path = '', sourcePath = '', destinationPath = '', compiler = null, config = null) => {
  // Normalize the path to a clean cwd-relative form, passed to templates as current_template_path
