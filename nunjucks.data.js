...
const alts = {
  ...
  'projects/middelen-meter/08_2x1': 'TODO: Three variations of the daily dashboard interface: the left shows logged alcohol entries (1 light beer and 4 glasses of wine), the centre shows the “sober today” button for alcohol, and the right shows a cigarette tracking screen confirming “Vandaag niets gerookt” with a smiley face.',
  'projects/middelen-meter/09_2x1': 'TODO: Three app pop-up screens: a reminder to accurately log all parts of the previous day, a pink congratulations screen with a smiley face for not drinking today, and a “HERINNER MIJ” window to set an alarm reminder for logging usage.',
  'projects/middelen-meter/10_1x1': 'TODO: The main app dashboard on day 3 of 7, displaying a progress bar, a central time-of-day selection dial, a pink plus button for custom logging, and a primary button that reads “NIETS GEDRONKEN DE HELE DAG”.',
  ...
  'projects/middelen-meter/12_2x1': 'TODO: Three side-by-side variations of the “GEBRUIK PER DAG” weekly bar chart screen. Each showcases a different substance tracking color scheme: orange for cigarettes, green for joints, and blue for sleeping pills, with consumption broken down by morning, afternoon, evening, and night.',
